...
function Notifications() {
  ...
  const onPointerUp = event => {
    ...
    // currentTarget.style.transition = 'transform 0.4s cubic-bezier(0.175, 0.885, 0.32, 1.1), height 0.4s ease'
    currentTarget.style.transition = 'transform 0.5s cubic-bezier(0.34, 1.56, 0.64, 1), height 0.5s ease'
